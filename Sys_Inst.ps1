...
choco install GoogleChrome keepass sdio Everything fastcopy vscode vlc telegram line picpick.portable firefox git terraform mRemoteNG meshcommander BGInfo choco-cleaner -y --ignore-checksums
